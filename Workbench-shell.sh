...
java $EXTRA_VMARGS -Xmx256M -cp "$APPDIR/src:$APPDIR/build/classes:$GWT_HOME/gwt-user.jar:$GWT_HOME/gwt-servlet.jar:$GWT_HOME/gwt-dev-$OS.jar$LIBS" com.google.gwt.dev.GWTShell -out "$APPDIR/build/gwtOutput" "$@" org.seasr.meandre.workbench.Workbench;
